...
call <sid>hi("Error",         s:col0, s:col1)
...
call <sid>hi("StatusLineNC",  s:cmnt, s:col0)
...
call <sid>hi("PMenu",         s:cmnt, s:hidn)
call <sid>hi("PMenuSel",      s:hidn, s:cmnt)
...
call <sid>hi("Todo",         s:col3, s:hidn)
call <sid>hi("Type",         s:scnd, "")
